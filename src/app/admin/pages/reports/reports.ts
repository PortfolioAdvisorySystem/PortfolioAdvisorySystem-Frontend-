...
export class ReportsComponent {
  ...
  strategyPage = 1;      // for allocation by strategy
  subscriberPage = 1;    // for allocation by subscriber
  migrationPage = 1;
  rebalancePage = 1;
  riskPage = 1;
  unallocatedPage = 1;
  ...
  get paginatedStrategies() {
    return this.paginate(this.strategies, this.strategyPage);
  }

  get paginatedSubscribers() {
    return this.paginate(this.subscribers, this.subscriberPage);
  }
